...
public class Step5 {
    public static boolean run(Configuration conf, Map<String, String> paths) {
        ...
        try {
            ...
            job.setSortComparatorClass(Step5.Step5Sort.class);
            job.setGroupingComparatorClass(Step5.Step5Group.class);
    ...
    public static class Step5Mapper extends Mapper<LongWritable, Text, PairWritable, Text> {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String[] lines2 =StringUtils.split(lines[1],',');
            String user = lines[0];
            String item = lines2[0];
            String num = lines2[1];
